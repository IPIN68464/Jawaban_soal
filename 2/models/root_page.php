...
<body>
	<div id='side-menu'>
		<div>
			<a href='add-account.php'><img src='../public/img/user-add.png' class='side-icon'/></a>
		</div>
		<div>
		...
		<div id='content'>
			...
			<div class="kotak">
				<?php foreach ($view as $data):?>
					<div class="kotakBTN">
						<div class="danger">
							<a class='text' href="root-edit.php?id_user=<?=$data['ID_USER'];?>&nama_user=<?=$data['NAMA_USER'];?>&username=<?=$data['USERNAME'];?>&password=<?=$data['PASSWORD'];?>&email=<?=$data['EMAIL'];?>&no_hp=<?=$data['NO_HP'];?>&wa=<?=$data['WA'];?>&PIN=<?=$data['PIN'];?>&id_jenis_user=<?=$data['ID_JENIS_USER'];?>&status_user=<?=$data['STATUS_USER'];?>&BTN=1">Delete</a>
						</div>
						<div class="warning">
							<a class='text' href="root-edit.php?id_user=<?=$data['ID_USER'];?>&nama_user=<?=$data['NAMA_USER'];?>&username=<?=$data['USERNAME'];?>&password=<?=$data['PASSWORD'];?>&email=<?=$data['EMAIL'];?>&no_hp=<?=$data['NO_HP'];?>&wa=<?=$data['WA'];?>&PIN=<?=$data['PIN'];?>&id_jenis_user=<?=$data['ID_JENIS_USER'];?>&status_user=<?=$data['STATUS_USER'];?>&BTN=2">Edit</a>
						</div>
					</div>
